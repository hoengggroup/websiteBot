...
## Introduction
This is a bot written in Python3 which monitors a given website for changes using an efficient $O(n^2)$ from-scratch implementation of a ```diff```-like difference tracker.
